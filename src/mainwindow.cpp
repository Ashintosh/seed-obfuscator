...
void MainWindow::on_btnObfuscate_clicked()
{
    ...
    std::string obfuscated_seed = seedstringtools::caesar_encrypt(seed_phrase, passphrase, offset_multiplier, false);
...
void MainWindow::on_btnDeobfuscate_clicked()
{
    ...
    std::string deobfuscated_seed = seedstringtools::caesar_encrypt(seed_phrase, passphrase, offset_multiplier, true);
